...
*/
    ...
    menuDev.innerHTML = '<a href="index.html#coding" class="menuheader">Developer</a>';
    const optionDev = document.createElement('div');
    optionDev.setAttribute('class', 'menuitems');
    optionDev.innerHTML = '<a href="page_resume.html">My Resume</a>' + 
    ...
    menuAbout.innerHTML = '<a href="index.html#about" class="menuheader">About&nbsp;Me</a>';
    const optionAbout = document.createElement('div');
    optionAbout.setAttribute('class', 'menuitems');
    optionAbout.innerHTML = '<a href="page_interpreter.html" style="display: none;">Interpreter</a>' + 
    ...
    optionTheme.innerHTML = '<a onclick="changeToLight()">Light Theme</a>' + 
        '<a onclick="changeToDark()">Dark Theme</a>';
    menuTheme.appendChild(optionTheme);

    const menuCard = document.createElement('div');
    menuCard.setAttribute('id', 'contactcard');
    menuCard.innerHTML = '<a href="http://benhwliu.com" target="_blank" class="carditem">benhwliu.com</a>';
    const optionCard = document.createElement('span');
    optionCard.setAttribute('class', 'cardicons');
    optionCard.innerHTML = '<a href="mailto:ben.liu.hwl@gmail.com"><i class="fa-regular fa-envelope fa-2x"></i></a>' + 
